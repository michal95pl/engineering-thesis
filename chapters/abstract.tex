...
\textbf{Słowa kluczowe} – szachy, sieci neuronowe, Monte Carlo Tree Search, wieloprocesowość, WU-UCT, ResNet, Squeeze-and-Excitation, SiLU, metoda batchowania danych, CNN, Normalizacja wsadowa, Rozpad wag, Wyżarzanie cosinusowe, Logit.
...
\textbf{Keywords} – chess, neural networks, Monte Carlo Tree Search, multiprocessing, WU-UCT, ResNet, Squeeze-and-Excitation, SiLU, data batching method, CNN, Batch Normalization, Weight Decay, Cosine Annealing, Logit.