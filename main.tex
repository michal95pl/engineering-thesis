...
\include{chapters/chess model/pgn data format}
\include{chapters/chess model/chess library}
\include{chapters/chess model/chess plus library}
\include{chapters/chess model/alghoritms/monte carlo tree search}
\include{chapters/chess model/alghoritms/neural network}
\include{chapters/chess model/alghoritms/parallel-mcts}
\include{chapters/chess model/evaluation}
\include{chapters/chess model/gui}
