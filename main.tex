...
\Large \textbf{Implementacja systemu do gry w szachy z wykorzystaniem analizy obrazu oraz równoległego algorytmu przeszukiwania stanów}
\par
}
...
\include{chapters/chess_model/data_processing}
\include{chapters/chess_model/alghoritms/monte_carlo_tree_search}
\include{chapters/chess_model/alghoritms/neural_network}
\include{chapters/chess_model/alghoritms/parallel-mcts}
\include{chapters/chess_model/architecture}
\include{chapters/chess_identification/chapters/Board/Board_preparation}
\include{chapters/chess_identification/chapters/Board/Board_identification}
\include{chapters/chess_identification/chapters/AI/CNN}
\include{chapters/chess_identification/chapters/AI/DataBase}
\include{chapters/chess_identification/chapters/GUI}
