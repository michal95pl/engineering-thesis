...
Drugim filarem pracy był system identyfikacji bierek szachowych na fizycznej planszy. Została ona specjalnie zaprojektowana z kolorowymi znacznikami w narożnikach, a także stworzono dedykowane figury ułatwiające ich detekcję.

Do detekcji planszy i bierek wykorzystano techniki przetwarzania obrazu oraz model sieci neuronowej z warstwami konwolucyjnymi. System został stworzony tak, aby mógł działać w pogorszonych warunkach oświetleniowych z uwzględnieniem cieni.
...
Kolejnym aspektem mogłoby być rozwinięcie modułu analizy obrazu, tak aby działał z wykorzystaniem standardowych bierek i planszy szachowej, bez konieczności stosowania specjalnych znaczników.