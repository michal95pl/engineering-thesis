...
Kluczowym elementem klasyfikacji obrazu jest wysoka jakość oraz reprezentatywność zbioru danych treningowych. W niniejszym rozdziale opisano autorskie podejście do fizycznego modelowania bierek oraz proces budowy zbioru danych obrazowych wykorzystanych do trenowania sieci splotowej \texttt{ChessCNN}.
