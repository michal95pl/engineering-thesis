...
Kluczowym elementem klasyfikacji obrazu jest wysoka jakość oraz reprezentatywność zbioru danych treningowych. W niniejszym rozdziale opisano autorskie podejście do fizycznego modelowania bierek oraz proces budowy zbioru danych obrazowych wykorzystanych do trenowania sieci \texttt{ChessCNN}.
...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{chapters/chess_identification/images/Train_material/B4_0_2.png}
    \caption{Wieża nr. 1}
    \end{minipage}
    \hfill
    \begin{minipage}{0.2\textwidth}
    \includegraphics[width=\textwidth]{chapters/chess_identification/images/Train_material/B4_0_5.png}
    \caption{Wieża nr. 2}
    \end{minipage}
    \hfill
    \begin{minipage}{0.2\textwidth}
    \includegraphics[width=\textwidth]{chapters/chess_identification/images/Train_material/B4_7_2.png}
    \caption{Wieża nr. 3}
    \end{minipage}
    \hfill
    \begin{minipage}{0.2\textwidth}
    \includegraphics[width=\textwidth]{chapters/chess_identification/images/Train_material/B4_7_5.png}
    \caption{Wieża nr. 4}
    \end{minipage}
\end{figure}
