...
\textbf{Słowa kluczowe} – szachy, sieci neuronowe, Monte Carlo Tree Search, wieloprocesowość, WU-UCT, ResNet, Squeeze-and-Excitation, SiLU, metoda batchowania danych, CNN, progowanie adaptacyjne, transformacja perspektywiczna.
...
\textbf{Keywords} – chess, neural networks, Monte Carlo Tree Search, multiprocessing, WU-UCT, ResNet, Squeeze-and-Excitation, SiLU, data batching method, CNN, adaptive thresholding, perspective transformation.