...
\chapter[Identyfikacja bierek szachowych {[\textit{Marcin Ziółkowski}]}]{Identyfikacja bierek szachowych}

Po dokonaniu transformacji perspektywicznej szachownicy, system przystępuje do fazy identyfikacji bierek. Proces ten odbywa się iteracyjnie dla każdego z 64 pól szachownicy i składa się z trzech głównych etapów: segmentacji lokalnej, ekstrakcji obiektu (kadrowania elipsoidalnego) oraz klasyfikacji za pomocą splotowej sieci neuronowej (CNN).
