...
Na rysunku 4.10 jest przedstawiony wykres porównawczy siedmiu gier rozegranych między opisywanym modelem z 9000 symulacjami, a Stockfishem. Większość partii dotrwała do ok 60 ruchów. Wszystkie partie zakończyły się przegraną, co jest zrozumiałe biorąc pod uwagę siłę Stockfisha.

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{images/mcts_4500.png}
\caption{Wykres przeżywalności MCTS względem Stockfish}
\end{figure}

\newpage

Rysunek 4.11 przedstawia wykres porównawczy siedmiu gier rozegranych między samą siecią neuronową, a Stockfishem. W tym przypadku sieć neuronowa nie korzysta z MCTS, a jedynie wybiera ruch na podstawie najwyższego prawdopodobieństwa zwracanego przez sieć. W porównaniu do poprzedniego wykresu, widać pogorszenie się wyników.
\begin{figure}[h]
\centering
