...
Format PGN jest powszechnie stosowanym standardem do przechowywania partii szachowych. W pojedynczym pliku może znajdować się dowolna ilość gier. Każda z nich zawiera między innymi informacje o nazwach graczy, wyniku oraz stosie ruchów. Taki sposób zapisu jest bardzo efektywny pamięciowo, gdyż nie zapisuje pełnego stanu planszy w każdej turze, a jedynie wykonywane ruchy. Dodatkowym atutem jest gotowa biblioteka \textit{python-chess} służąca do dekodowania pliku oraz znajdujących się w nich rozgrywek.
