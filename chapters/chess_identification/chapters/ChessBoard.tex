\section{Przetwarzanie i przygotowanie obrazu szachownicy}

Proces przygotowania szachownicy do analizy składa się z kilku etapów przetwarzania wstępnego, mających na 
celu wyeliminowanie zniekształceń perspektywicznych oraz precyzyjne wykadrowanie obszaru gry. Moduł \texttt{BoardTransformation} 
realizuje to zadanie poprzez detekcję markerów kolorystycznych oraz wykorzystanie algorytmów wizji komputerowej biblioteki OpenCV.

\subsection{Detekcja punktów referencyjnych}
...
\subsection{Orientacja i transformacja perspektywiczna}
...
\subsection{Precyzyjne kadrowanie i finalna normalizacja}
