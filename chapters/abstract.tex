...
The aim of this thesis is the design and implementation of a parallel chess engine based on the Monte Carlo Tree Search algorithm, supported by a deep neural network. The solution is inspired by the AlphaZero architecture, enhanced by modern deep learning techniques.

A dataset from the Lichess Elite Database was used to train the neural network. The implemented neural network utilizes a residual architecture extended with Squeeze-and-Excitation blocks and the SiLU activation function.

Another key aspect of the work is the parallelization of the MCTS algorithm. To efficiently utilize GPU and CPU resources, a multiprocess Tree Parallelization method was applied in combination with the Watch the Unobserved technique and a data batching mechanism.
