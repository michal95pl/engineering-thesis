...
\caption[Wykres loss dla modelu bez bloków SE]{Wykres loss dla modelu bez bloków SE. Wykres przedstawia co drugą epokę.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{images/nomal-model.png}
\caption[Wykres loss dla modelu z blokami SE]{Wykres loss dla modelu z blokami SE. Wykres przedstawia co drugą epokę.}
\end{figure}
...
\caption[Wykres loss dla modelu z funkcją ReLu]{Wykres loss dla modelu z funkcją ReLu. Wykres przedstawia co drugą epokę.}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{images/nomal-model.png}
\caption[Wykres loss dla modelu z funkcją SiLu]{Wykres loss dla modelu z funkcją SiLu. Wykres przedstawia co drugą epokę.}
\end{figure}
...
\caption[Funkcja loss ze współczynnikiem 3]{Funkcja loss ze współczynnikiem 3. Wykres przedstawia co drugą epokę}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{images/x4-net.png}
\caption[Funkcja loss ze współczynnikiem 4]{Funkcja loss ze współczynnikiem 4. Wykres przedstawia co drugą epokę}
\end{figure}
...
\centering
\includegraphics[width=0.9\textwidth]{images/nomal-model.png}
\caption[Wykres loss dla końcowego modelu]{Wykres loss dla końcowego modelu. Wykres przedstawia co drugą epokę}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{images/7_res_block_net.png}
\caption[Wykres loss dla modelu z 7 blokami rezydualnymi]{Wykres loss dla modelu z 7 blokami rezydualnymi. Wykres przedstawia co drugą epokę}
\end{figure}
